...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqldb://Jimbop01:Database*001@Jimbop01.mysql.pythonanywhere-services.com/Jimbop01$EarlyYears'
...
def login():
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            print(is_valid)
            if is_valid:
                flash(f'welcome to Early Years {username}!')
